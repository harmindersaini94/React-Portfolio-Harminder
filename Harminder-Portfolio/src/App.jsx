...
function App() {
  ...
  return (
    <>
      <motion.div
        className="fixed top-0 left-0 right-0 h-1.5 bg-teal-600 origin-[0%]"
        style={{ scaleX }}
      />
...
<div  className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-teal-950 flex py-12 px-4 lg:px-8"></div>
        </div>
